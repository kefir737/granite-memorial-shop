...
cp /opt/granite/vps/nginx/kladbishe-kiovo.ru.conf /etc/nginx/sites-available/kladbishe-kiovo.ru

ln -sf /etc/nginx/sites-available/granit-sever.ru /etc/nginx/sites-enabled/
ln -sf /etc/nginx/sites-available/kladbishe-kiovo.ru /etc/nginx/sites-enabled/
...
echo "  3. Запустить: certbot --nginx -d kladbishe-kiovo.ru -d www.kladbishe-kiovo.ru"
