...
CREATE TABLE IF NOT EXISTS menu_items (
    ...
    menu_type VARCHAR(20) NOT NULL DEFAULT 'header',
    parent_id INT DEFAULT NULL
) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

ALTER TABLE menu_items ADD COLUMN IF NOT EXISTS menu_type VARCHAR(20) NOT NULL DEFAULT 'header';
ALTER TABLE menu_items ADD COLUMN IF NOT EXISTS parent_id INT DEFAULT NULL;
